...
shutil.copy2(path[option], "history.sqlite3")
...
con = sqlite3.connect("history.sqlite3", timeout=5)
df = pd.read_sql_query(query[option], con)
con.close()
